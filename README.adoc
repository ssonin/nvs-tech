...
* link:src/main/resources/db/migration/V001__create_clients_table.sql[V002]: Clients table with search vectors
* link:src/main/resources/db/migration/V002__create_documents_table.sql[V003]: Documents table with search vectors
